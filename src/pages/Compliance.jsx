    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-5">
          <div className="w-16 h-16 rounded-2xl bg-amber-500 text-white flex items-center justify-center font-extrabold text-2xl shadow-xs shrink-0">
            {COMPLIANCE_DATA.complianceScore}
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-extrabold text-slate-900">Compliance Score: 72 / 100</h2>
              <span className="px-2.5 py-0.5 rounded-full bg-amber-100 text-amber-800 font-bold text-xs">
                {COMPLIANCE_DATA.riskLevel} RISK
              </span>
            </div>
        ...
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 max-w-md space-y-1">
          ...
          <p className="text-xs text-slate-700 font-medium leading-relaxed">
            "{COMPLIANCE_DATA.recommendation}"
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-2">
          ...
          <h3 className="text-lg font-extrabold text-amber-700">{COMPLIANCE_DATA.gstFilingStatus}</h3>
          <p className="text-[11px] font-bold text-slate-700">Due Date: {COMPLIANCE_DATA.gstDueDate}</p>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-2">
          <span className="text-xs text-slate-500 font-semibold uppercase">Income Tax Filing</span>
          <h3 className="text-lg font-extrabold text-emerald-700">{COMPLIANCE_DATA.taxFilingStatus}</h3>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-2">
          ...
          <h3 className="text-lg font-extrabold text-amber-700">{COMPLIANCE_DATA.taxPaymentStatus}</h3>
          <p className="text-[11px] text-slate-500">Last Filing: {COMPLIANCE_DATA.lastFilingDate}</p>
        </div>
